...
- <b>ui:</b> Also a <i>ReactJS</i> app where you can do everything related with Meshery. It is the Service Mesh Management Plane
...
If you are writing your first test, you can read and watch the <b><u><a href="https://docs.cypress.io/guides/getting-started/writing-your-first-test.html">great getting started</a></u></b> from Cypress blog.
...
To improve writing better tests, I recommend to you to watch:
- <b><a href="">Meshery Development Meeting (Nov 4th, 2020)</a></b> where I gave a demo running UI tests on the Meshery project
- <b><a href="https://docs.cypress.io/examples/examples/tutorials.html">Tutorial Videos</a></b> from Cypress blog.
- The <b><a href="https://www.youtube.com/watch?v=5XQOK0v_YRE">Brian Mann – I see your point, but… (Part 1)</a></b> YouTube video where he gives pro tips writing tests in Cypress.

If you have questions, do not hesitate to ask to the Meshery community on Slack :)

Happy testing!

\- _Rodolfo Martínez Vega_
